...
export function DetailDrawer() {
  ...
  return (
    <div
      className={cn(
        'fixed right-0 top-1/2 transform -translate-y-1/2 w-[20vw] h-[75vh] bg-background border-1 shadow-lg transition-transform duration-300 ease-in-out z-40 rounded-md',
